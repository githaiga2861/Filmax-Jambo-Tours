  ...
  function showPrompt() {
    ...
    overlay.innerHTML = [
      ...
      '">',
        ...
        '<div style="font-size:36px;margin-bottom:20px;"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:-3px;"><path d="M9 18V5l11-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="17" cy="16" r="3"/></svg></div>',
        ...
        '<div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">',
          ...
          '">',
            '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="display:inline-block;vertical-align:-3px;"><path d="M4 9v6h4l5 4V5L8 9H4z"/><path d="M16 9a4 4 0 0 1 0 6"/></svg> &nbsp;Yes, Play Sound',
          '</button>',
